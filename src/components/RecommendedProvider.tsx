        ...
        <Card className="max-w-2xl mx-auto border-2 shadow-lg">
          <CardContent className="p-6 flex flex-col md:flex-row items-center justify-between">
            <div className="text-center md:text-left mb-4 md:mb-0">
              ...
              <p className="text-muted-foreground mb-2">Wereldwijd een van de grootste banken, bekend om betrouwbaarheid en klantgerichtheid.</p>
              ...
              <p className="text-sm text-muted-foreground mt-2">Binnen 2 werkdagen op je rekening</p>
            </div>
            <Link to="/aanvragen">
